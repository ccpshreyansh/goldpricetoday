...
<>    <div className={styles.container}>
      <h1><span style={{ color: "#e0b963" }}>Gold Prices in</span><span> </span> 
      {city.charAt(0).toUpperCase() + city.slice(1)}</h1>
      ...
      <p className={styles.description}>
        <br></br>
        The price of gold in India today is ₹ 7,435 per gram for 22 karat gold and ₹ 8,111 per gram for 24 karat gold (also called 999 gold).{" "}
